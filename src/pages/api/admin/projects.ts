...
export const GET: APIRoute = async ({ request }) => {
  ...
  let query = supabase
    .from('projects')
    .select('id, created_at, updated_at, lead_id, status, admin_notes, lead_score, next_action, follow_up_date, assigned_admin_id, project_value_estimate, project_leads(full_name, email, project_type, project_title)')
